...
const Sidebar = () => {
  ...
  <Box>
    <IconButton sx={styles.icon}><TeamIcon /></IconButton>
    <Typography sx={styles.label1}>V.1.0.02</Typography>
    <Divider sx={styles.divider} />
    <IconButton sx={styles.team}><PersonIcon /></IconButton>
    <Typography sx={styles.label}>Profile</Typography>
    <IconButton sx={styles.section}><TeamsIcon /></IconButton>
    <Typography sx={styles.label}>Team</Typography>
    <IconButton sx={styles.team}><CommentsIcon /></IconButton>
    <Typography sx={styles.label2}>Feedback</Typography>
  </Box>

  <Box sx={styles.bottom}>
    <IconButton sx={styles.team}><SettingsIcon /></IconButton>
    <IconButton sx={styles.team}><NotifyIcon /></IconButton>
    <IconButton sx={styles.team}><LogoutIcon /></IconButton>
  </Box>
</Box>
